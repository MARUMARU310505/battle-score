!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"62b1d5642f92b752cf0e1cabf779a78d6df88b76"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="dc8d2443-039b-4f56-a243-58f0f584009f",e._sentryDebugIdIdentifier="sentry-dbid-dc8d2443-039b-4f56-a243-58f0f584009f");}catch(e){}}();import './page-ssr_B4554CU1.mjs';
import { c as createComponent } from './astro-component_Dg49gEqV.mjs';
import 'piccolore';
import { Q as renderTemplate, T as maybeRenderHead } from './params-and-props_CE93fwXy.mjs';
import { r as renderComponent } from './entrypoint_DXnrXpqc.mjs';
import { a as actions } from './server_VnUoNZcZ.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { AlertCircle, User, Award, Loader2 } from 'lucide-react';
import { useState } from 'react';
import { B as Button, N as Nav } from './nav_BgCT-LjH.mjs';
import { $ as $$BaseLayout } from './base-layout_CWKFFSPf.mjs';
...
function ProfileForm({ initialProfile }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "mx-auto w-full max-w-md", children: /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-xl border border-border bg-card text-card-foreground shadow-lg backdrop-blur-md", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6 p-6 xl:p-8", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center space-y-4 py-2 w-full", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2 w-full max-w-xs", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-2 border border-border/40 bg-background/30 rounded-lg p-2.5 w-full", children: AVATAR_PRESETS.map((preset) => {
          ...
          return /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `relative aspect-square cursor-pointer rounded-md overflow-hidden border p-1 transition-all duration-200 hover:scale-105 ${isSelected ? "border-primary bg-primary/10" : "border-border bg-card/50 hover:border-border/80"}`,
