!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"80798b979a173e3ac17388256b90007af3e7f4c4"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e9ad7e66-0ec3-415e-9fd8-cd4c24328fdd",e._sentryDebugIdIdentifier="sentry-dbid-e9ad7e66-0ec3-415e-9fd8-cd4c24328fdd");}catch(e){}}();import './server_hPCZ1WRb.mjs';
...
import { d as defineAction, A as ActionError } from './entrypoint_CqCC9dp2.mjs';
  ...
  squad: {
    create: defineAction({
      ...
      handler: async (input, context) => {
        ...
        const membersToInsert = input.members.map((m) => ({
          ...
          user_id: m.slot_number === 1 ? user.id : null
          // Creator claims slot 1 (leader)
        }));
    ...
    claimSlot: defineAction({
      ...
      handler: async (input, context) => {
        ...
        const { error: claimError } = await supabase.from("squad_members").update({ user_id: user.id }).eq("id", existingMember.id);
        if (claimError) {
    ...
    releaseSlot: defineAction({
      ...
      handler: async (input, context) => {
        ...
        const { error } = await supabase.from("squad_members").update({ user_id: null }).eq("squad_id", input.squadId).eq("slot_number", input.slotNumber).eq("user_id", user.id);
        if (error) {
