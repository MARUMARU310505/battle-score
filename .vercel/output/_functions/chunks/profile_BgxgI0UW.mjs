!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"805457d8ec1c94ee4030256bb46249a10dc0d51b"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="5221df23-a297-4b6e-a3f8-164ddbaeebd4",e._sentryDebugIdIdentifier="sentry-dbid-5221df23-a297-4b6e-a3f8-164ddbaeebd4");}catch(e){}}();import './page-ssr_CnLsw0St.mjs';
import { c as createComponent } from './astro-component_BmbHrSPq.mjs';
import 'piccolore';
import { Q as renderTemplate, T as maybeRenderHead } from './params-and-props_B78HSBYz.mjs';
import { r as renderComponent } from './entrypoint_DXf4qnR8.mjs';
import { a as actions } from './server_BxPQXk8q.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { AlertCircle, User, Award, Loader2 } from 'lucide-react';
import { useState } from 'react';
import { B as Button, N as Nav } from './nav_C12M2LKU.mjs';
import { $ as $$BaseLayout } from './base-layout_CyNnp3Dn.mjs';
...
function ProfileForm({ initialProfile }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "mx-auto w-full max-w-md", children: /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-xl border border-border bg-card text-card-foreground shadow-lg backdrop-blur-md", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6 p-6 xl:p-8", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center space-y-2 py-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "group relative", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "relative flex h-20 w-20 items-center justify-center rounded-full border border-border bg-card shadow-lg", children: gamertag.trim() ? /* @__PURE__ */ jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsx("span", { className: "font-mono text-[10px] text-muted-foreground uppercase tracking-wider", children: "Vista previa del avatar" })
    ] }),
