!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"2b65c6ef690c3e8b5431b79d1cc4317f26dad519"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="08f83f10-863a-4711-b1ae-4ac384e4b807",e._sentryDebugIdIdentifier="sentry-dbid-08f83f10-863a-4711-b1ae-4ac384e4b807");}catch(e){}}();import { jsx, jsxs } from 'react/jsx-runtime';
...
import { a as createSupabaseBrowserClient } from './supabase_Dg3IZhZb.mjs';
...
function Nav({ user = null }) {
  ...
  return /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-50 w-full border-border border-b bg-background/80 backdrop-blur-md", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex h-20 max-w-7xl items-center justify-between px-4 xl:px-6 xl:px-8", children: [
    /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsx("a", { className: "flex items-center space-x-2", href: "/", children: /* @__PURE__ */ jsxs("span", { className: "font-bold text-foreground text-xl tracking-tight", children: [
      "Battle Score",
      /* @__PURE__ */ jsx("span", { className: "ml-1.5 border-border border-l pl-1.5 font-light font-sans text-muted-foreground text-sm uppercase xl:inline-block hidden", children: "BR Analytics" })
    ] }) }) }),
