!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"80798b979a173e3ac17388256b90007af3e7f4c4"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="5d855886-c812-4c0f-942b-53022e0bd7e2",e._sentryDebugIdIdentifier="sentry-dbid-5d855886-c812-4c0f-942b-53022e0bd7e2");}catch(e){}}();import './page-ssr_3D5t1dS6.mjs';
import { c as createComponent } from './astro-component_CECIzGVK.mjs';
import 'piccolore';
import { Q as renderTemplate, T as maybeRenderHead } from './params-and-props_az1v7bOW.mjs';
import { r as renderComponent } from './entrypoint_CqCC9dp2.mjs';
import { a as actions } from './server_hPCZ1WRb.mjs';
import { jsx, jsxs } from 'react/jsx-runtime';
import { Plus, Users, Check, Copy, LogIn, LogOut, ShieldCheck, Search } from 'lucide-react';
import { useState } from 'react';
import { B as Button, N as Nav } from './nav_nPucLdXR.mjs';
import { S as SquadWizard } from './squad-wizard_BQajnWd3.mjs';
              ...
              foundSquad.squad_members.filter((m) => m.user_id === null).length === 0 ? /* @__PURE__ */ jsx("p", { className: "font-light text-destructive text-xs italic", children: "Este escuadrón ya no tiene slots libres disponibles." }) : /* @__PURE__ */ jsx("div", { className: "space-y-2", children: foundSquad.squad_members.sort((a, b) => a.slot_number - b.slot_number).map((member) => {
                ...
                return /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    disabled: isClaimed,
                    onClick: () => !isClaimed && setSelectedSlot(member.slot_number),
                    type: "button",
                    children: [
                      /* @__PURE__ */ jsxs("div", { children: [
