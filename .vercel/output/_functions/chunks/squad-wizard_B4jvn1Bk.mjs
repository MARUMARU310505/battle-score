!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"9ae64c8afd338efbfe8b2be798182d2f20d2e584"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="5c9cc98a-15a7-4de9-8e3d-e08d5357380c",e._sentryDebugIdIdentifier="sentry-dbid-5c9cc98a-15a7-4de9-8e3d-e08d5357380c");}catch(e){}}();import { jsx, jsxs } from 'react/jsx-runtime';
import { a as actions } from './server_DBcyIy7C.mjs';
import { createContext, useState, useCallback, useContext } from 'react';
import { c as cn, B as Button } from './nav_PJf1Tk3X.mjs';
  ...
  const handleNext = () => {
    ...
    setMembers((prev) => {
      ...
      const otherMembers = Array.from({ length: slotCount - 1 }).map((_, i) => {
        ...
        return existing ? { ...existing, slot_number: i + 2 } : {
          gamertag: "",
          level: 1,
          favorite_class: CLASSES[i % CLASSES.length] || "Asalto",
          slot_number: i + 2
    ...
    !initialSquad && step === 1 && /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("select", { className: "w-full rounded-md border border-border bg-background px-3 py-2 text-foreground text-sm", value: slotCount, onChange: (e) => setSlotCount(Number(e.target.value)), children: Array.from({ length: 8 }, (_, i) => i + 1).map((num) => /* @__PURE__ */ jsxs("option", { value: num, children: [
            num,
            " Operador",
            num > 1 ? "es" : ""
          ] }, num)) })
