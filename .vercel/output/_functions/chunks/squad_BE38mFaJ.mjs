!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"0f5592c27bdbf924f4cd59af20d6d6f67364ea24"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="19062aa4-84ee-4c46-914d-ff678686d9ee",e._sentryDebugIdIdentifier="sentry-dbid-19062aa4-84ee-4c46-914d-ff678686d9ee");}catch(e){}}();import './page-ssr_zTXWUWsp.mjs';
import { c as createComponent } from './astro-component_B73C5kgH.mjs';
import 'piccolore';
import { Q as renderTemplate, T as maybeRenderHead } from './params-and-props_CKchjuj7.mjs';
import { r as renderComponent } from './entrypoint_a031BDoZ.mjs';
import { a as actions } from './server_DRmZJ5_Z.mjs';
...
import { B as Button, N as Nav } from './nav_1dhO3SJY.mjs';
import { S as SquadWizard } from './squad-wizard_nuduxSQO.mjs';
import { $ as $$BaseLayout } from './base-layout_BLACfiwT.mjs';
...
function SquadSidebar({
  ...
  return /* @__PURE__ */ jsxs("aside", { className: "flex min-h-[calc(100vh-4rem)] w-full flex-col justify-between border-border border-r bg-card p-4 md:w-64", children: [
        ...
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              canToggle && /* @__PURE__ */ jsx("div", { className: "flex justify-end border-border/40 border-t pt-2", children: /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  onClick: () => handleToggleActive(member.slot_number, member.is_active),
                  type: "button",
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-6 space-y-2 border-border border-t pt-4", children: isOwner ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(
        Button,
        {
          className: "w-full",
