!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"1925b883e5c22e8ed29796d028a0d87b4f72a35d"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="3886ac27-c1d9-40ea-b830-d8ffc16bd03e",e._sentryDebugIdIdentifier="sentry-dbid-3886ac27-c1d9-40ea-b830-d8ffc16bd03e");}catch(e){}}();import { jsx, jsxs } from 'react/jsx-runtime';
import { a as actions } from './server_B3r0hFnE.mjs';
import { createContext, useState, useCallback, useContext } from 'react';
import { c as cn, B as Button } from './nav_D7dMZNHy.mjs';
...
function SquadSidebar({
  ...
  return /* @__PURE__ */ jsxs("aside", { className: "flex min-h-0 w-full flex-col justify-between border-border border-r bg-card p-4 xl:min-h-[calc(100vh-4rem)] xl:w-64", children: [
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-3", children: Array.from({ length: squad.slot_count || 4 }, (_, i) => i + 1).map((slotNumber) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-2xl rounded-lg border border-border bg-card p-6 shadow-sm xl:p-8", children: [
    ...
    !initialSquad && step === 1 && /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "mb-2 block font-medium text-foreground text-sm", children: "Número de integrantes" }),
          /* @__PURE__ */ jsxs("select", { className: "w-full rounded-md border border-border bg-background px-3 py-2 text-foreground text-sm", value: slotCount, onChange: (e) => setSlotCount(Number(e.target.value)), children: [
            /* @__PURE__ */ jsx("option", { value: 1, children: "1 Operador (Solo)" }),
            /* @__PURE__ */ jsx("option", { value: 2, children: "2 Operadores (Dúo)" }),
            /* @__PURE__ */ jsx("option", { value: 4, children: "4 Operadores (Cuarteto)" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "mb-2 block font-medium text-foreground text-sm", children: "Código de acceso" }),
          /* @__PURE__ */ jsx("input", { className: "w-full rounded-md border border-border bg-background px-3 py-2 text-foreground text-sm", value: accessCode, onChange: (e) => setAccessCode(e.target.value), placeholder: "Opcional" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-3", children: [
        onCancel && /* @__PURE__ */ jsx(Button, { onClick: onCancel, type: "button", variant: "outline", children: "Cancelar" }),
