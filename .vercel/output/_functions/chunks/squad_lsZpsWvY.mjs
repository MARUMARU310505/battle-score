!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"c8a40707f66851908d1d47b9e7c7c38512cae772"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="3673cf15-dee1-4d79-884b-e030878e55c5",e._sentryDebugIdIdentifier="sentry-dbid-3673cf15-dee1-4d79-884b-e030878e55c5");}catch(e){}}();import './page-ssr_BaFgG7Pg.mjs';
import { c as createComponent } from './astro-component_Dn0_w7C8.mjs';
import 'piccolore';
import { Q as renderTemplate, T as maybeRenderHead } from './params-and-props_BQKzcMjR.mjs';
import { r as renderComponent } from './entrypoint_BIgG_yUe.mjs';
import { a as actions } from './server_DY2P2dgH.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { Activity, Calendar, BarChart3, Sparkles, Settings, Zap, ShieldAlert, Compass, UserCheck, UserMinus, Play, Power, Loader2, Trophy, Crosshair, Target, ChevronUp, ChevronDown, TrendingUp, Heart, HelpCircle, Check, Copy } from 'lucide-react';
import { useState, useEffect, useMemo } from 'react';
import { B as Button, N as Nav } from './nav_CtTENqSO.mjs';
import { O as OperatorAvatar, c as cleanGamertag, u as useNotification, S as SquadWizard, N as NotificationProvider, a as SquadSidebar } from './squad-wizard_BfiCbwKD.mjs';
import { a as createSupabaseBrowserClient } from './supabase_BmfN9ZuK.mjs';
import { $ as $$BaseLayout } from './base-layout_BSwF7anM.mjs';
...
function SessionLiveStats({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fade-in-50 mt-4 animate-in space-y-5 duration-200", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 sm:grid-cols-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border/60 bg-muted/20 p-3 text-center", children: [
        /* @__PURE__ */ jsxs("p", { className: "font-mono text-[9px] text-muted-foreground uppercase", children: [
          "KDR",
          " "
        ] }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 font-bold font-sans text-primary text-xl", children: sessionKdr })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border/60 bg-muted/20 p-3 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "font-mono text-[9px] text-muted-foreground uppercase", children: "Partidas" }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 font-bold font-sans text-foreground text-xl", children: totalMatches })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border/60 bg-muted/20 p-3 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "font-mono text-[9px] text-muted-foreground uppercase", children: "Prom. Puesto" }),
        /* @__PURE__ */ jsxs("p", { className: "mt-1 font-bold font-sans text-foreground text-xl", children: [
          "#",
          avgPlacement
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border/60 bg-muted/20 p-3 text-center", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "mt-1 font-bold font-sans text-emerald-500 text-xl", children: [
          winRate,
          "%"
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card/40 p-4", children: [
      /* @__PURE__ */ jsxs("h4", { className: "mb-3 flex items-center gap-1.5 font-bold text-foreground text-xs uppercase tracking-wider", children: [
        ...
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center gap-4 text-right font-mono", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "border-border/30 border-l pl-3 text-[10px]", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-primary/20 bg-primary/5 p-4", children: [
      /* @__PURE__ */ jsxs("h4", { className: "mb-2.5 flex items-center gap-1.5 font-bold text-primary text-xs uppercase tracking-wider", children: [
      ...
      alerts.length === 0 ? /* @__PURE__ */ jsx("p", { className: "font-light text-muted-foreground text-xs", children: "🟢 Escuadrón estable. Concentración óptima. Sigan comunicando y rotando de forma limpia." }) : /* @__PURE__ */ jsx("div", { className: "space-y-3", children: alerts.map((alert, idx) => /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        suggestions[idx] && /* @__PURE__ */ jsx("p", { className: "border-border/60 border-l-2 pl-4 font-light text-foreground text-xs leading-relaxed", children: suggestions[idx] })
      ] }, idx)) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card/40 p-4", children: [
      /* @__PURE__ */ jsxs("h4", { className: "mb-3 flex items-center gap-1.5 font-bold text-foreground text-xs uppercase tracking-wider", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-2", children: sortedPois.slice(0, 3).map((poi) => /* @__PURE__ */ jsxs(
        "div",
        {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          ] }) : /* @__PURE__ */ jsx("span", { className: "w-full rounded border border-border/30 bg-muted/40 px-2 py-1 text-center font-mono text-[10px] text-muted-foreground/60 italic", children: "Slot disponible (Invitación)" }) })
        ]
      },
      player.slot_number
    );
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 border-border/40 border-b pb-4 sm:flex-row sm:items-center sm:justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              className: `cursor-pointer border-b-2 pb-1 font-bold text-xs uppercase tracking-wider transition-all ${subTab === "list" ? "border-primary text-foreground" : "border-transparent text-muted-foreground hover:text-foreground"}`,
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              className: `cursor-pointer border-b-2 pb-1 font-bold text-xs uppercase tracking-wider transition-all ${subTab === "stats" ? "border-primary text-foreground" : "border-transparent text-muted-foreground hover:text-foreground"}`,
...
function StatsView({ matches, squad, currentUserId }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fade-in-50 animate-in space-y-6 duration-300", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 sm:grid-cols-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-lg border border-border bg-card p-4 shadow-sm", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-3 right-3 opacity-15", children: /* @__PURE__ */ jsx(Zap, { className: "h-6 w-6 text-primary" }) }),
        /* @__PURE__ */ jsx("p", { className: "font-mono text-[10px] text-muted-foreground uppercase tracking-wider", children: "KDR Global" }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 font-bold font-sans text-2xl text-primary", children: summary.globalKdr }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-lg border border-border bg-card p-4 shadow-sm", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-3 right-3 opacity-15", children: /* @__PURE__ */ jsx(BarChart3, { className: "h-6 w-6 text-muted-foreground" }) }),
        /* @__PURE__ */ jsx("p", { className: "font-mono text-[10px] text-muted-foreground uppercase tracking-wider", children: "Partidas" }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 font-bold font-sans text-2xl text-foreground", children: summary.totalMatches }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-[10px] text-muted-foreground", children: "Sesiones de juego" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-lg border border-border bg-card p-4 shadow-sm", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-3 right-3 opacity-15", children: /* @__PURE__ */ jsx(Compass, { className: "h-6 w-6 text-muted-foreground" }) }),
        /* @__PURE__ */ jsx("p", { className: "font-mono text-[10px] text-muted-foreground uppercase tracking-wider", children: "Puesto Promedio" }),
        /* @__PURE__ */ jsxs("p", { className: "mt-1 font-bold font-sans text-2xl text-foreground", children: [
          "#",
          summary.avgPlacement
        ] }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-[10px] text-muted-foreground", children: "Efectividad de zona" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-lg border border-border bg-card p-4 shadow-sm", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-3 right-3 opacity-15", children: /* @__PURE__ */ jsx(TrendingUp, { className: "h-6 w-6 text-emerald-500" }) }),
        /* @__PURE__ */ jsx("p", { className: "font-mono text-[10px] text-muted-foreground uppercase tracking-wider", children: "Tasa de Victorias" }),
        /* @__PURE__ */ jsxs("p", { className: "mt-1 font-bold font-sans text-2xl text-emerald-500", children: [
          summary.winRate,
          "%"
        ] }),
        /* @__PURE__ */ jsxs("p", { className: "mt-1 text-[10px] text-muted-foreground", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2", children: [
      dropZones.dropGanador && /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-5 shadow-xs", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-4 right-4 rounded-full bg-emerald-500/10 p-2", children: /* @__PURE__ */ jsx(Sparkles, { className: "h-5 w-5 animate-pulse text-emerald-400" }) }),
        /* @__PURE__ */ jsx("h4", { className: "font-bold font-mono text-emerald-400 text-xs uppercase tracking-widest", children: "🚀 El Drop Ganador" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 font-bold text-foreground text-lg", children: dropZones.dropGanador.name }),
        /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-4 font-mono text-xs", children: [
          /* @__PURE__ */ jsxs("div", { children: [
      ...
      dropZones.rutaMuerte && /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-lg border border-destructive/20 bg-destructive/5 p-5 shadow-xs", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-4 right-4 rounded-full bg-destructive/10 p-2", children: /* @__PURE__ */ jsx(ShieldAlert, { className: "h-5 w-5 text-destructive" }) }),
        /* @__PURE__ */ jsx("h4", { className: "font-bold font-mono text-destructive text-xs uppercase tracking-widest", children: "💀 Ruta de la Muerte" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 font-bold text-foreground text-lg", children: dropZones.rutaMuerte.name }),
        /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-4 font-mono text-xs", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Puesto Prom.:" }),
            " ",
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-5", children: [
        /* @__PURE__ */ jsx("h3", { className: "mb-4 border-border/40 border-b pb-3 font-bold text-foreground text-xs uppercase tracking-wider", children: "Anatomía de la Derrota (Causas)" }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3.5", children: defeatCauses.list.length === 0 ? /* @__PURE__ */ jsx("p", { className: "py-6 text-center font-light text-muted-foreground text-xs", children: "No hay derrotas registradas todavía." }) : defeatCauses.list.map((cause) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-1.5 flex items-center justify-between font-mono text-xs", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-5", children: [
        /* @__PURE__ */ jsx("h3", { className: "mb-4 border-border/40 border-b pb-3 font-bold text-foreground text-xs uppercase tracking-wider", children: "Curva de Fatiga y Desempeño" }),
        /* @__PURE__ */ jsx("div", { className: "space-y-4", children: fatigueData.map((data) => {
          ...
          return /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-1.5 flex flex-col gap-1.5 font-mono text-xs sm:flex-row sm:items-center sm:justify-between", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-[10px]", children: [
                ...
                /* @__PURE__ */ jsxs("span", { children: [
                  "Estado Mental:",
                  " ",
                  /* @__PURE__ */ jsx("span", { className: "font-bold text-emerald-400", children: mentalLabel(data.avgMental) })
                ] })
              ] })
            ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-5 lg:col-span-1", children: [
        /* @__PURE__ */ jsx("h3", { className: "mb-4 border-border/40 border-b pb-3 font-bold text-foreground text-xs uppercase tracking-wider", children: "Matriz de Especialidades" }),
        /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left font-mono text-xs", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-border/20 border-b pb-2 text-muted-foreground", children: [
            /* @__PURE__ */ jsx("th", { className: "pb-2 font-medium", children: "Clase" }),
            /* @__PURE__ */ jsx("th", { className: "pb-2 text-center font-medium", children: "KDR" }),
            /* @__PURE__ */ jsx("th", { className: "pb-2 text-center font-medium", children: "Win %" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { children: classStats.map((cls) => /* @__PURE__ */ jsxs(
            "tr",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("td", { className: "py-2.5 text-center font-bold text-primary", children: cls.kdr }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-5 lg:col-span-2", children: [
        /* @__PURE__ */ jsx("h3", { className: "mb-4 border-border/40 border-b pb-3 font-bold text-foreground text-xs uppercase tracking-wider", children: "Comparador de Operadores" }),
        /* @__PURE__ */ jsx("div", { className: "block space-y-3 sm:hidden", children: operatorStats.map((op) => {
          const isMe = op.userId === currentUserId;
          return /* @__PURE__ */ jsxs(
            "div",
            {
              className: `relative overflow-hidden rounded-lg border bg-muted/10 p-4 transition-all hover:bg-muted/15 ${isMe ? "border-emerald-500/30 bg-emerald-500/[0.02]" : "border-border"}`,
              children: [
                    ...
                    /* @__PURE__ */ jsxs(
                      "span",
                      {
                        ...
                        children: [
                          ...
                          isMe && /* @__PURE__ */ jsx("span", { className: "ml-1.5 rounded bg-emerald-500/20 px-1.5 py-0.5 font-mono text-[9px] text-emerald-400", children: "Tú" })
                        ]
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end", children: [
                    /* @__PURE__ */ jsx("span", { className: "font-mono text-[9px] text-muted-foreground uppercase tracking-wider", children: "KDR" }),
                    /* @__PURE__ */ jsx("span", { className: "font-extrabold font-mono text-primary text-sm", children: op.kdr })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-2 border-border/30 border-t pt-3 text-center", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "font-mono text-[9px] text-muted-foreground uppercase", children: "Partidas" }),
                    /* @__PURE__ */ jsx("p", { className: "mt-0.5 font-bold font-mono text-foreground text-xs", children: op.count })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "font-mono text-[9px] text-muted-foreground uppercase", children: "K/D/A" }),
                    /* @__PURE__ */ jsxs("p", { className: "mt-0.5 font-bold font-mono text-foreground text-xs", children: [
                      op.kills,
                      "/",
                      op.downs,
                      "/",
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsxs("p", { className: "flex items-center justify-center gap-0.5 font-mono text-[9px] text-muted-foreground uppercase", children: [
                      /* @__PURE__ */ jsx(Heart, { className: "h-2 w-2 fill-red-500 text-red-500" }),
                      " ",
                      "Reanim."
                    ] }),
                    /* @__PURE__ */ jsx("p", { className: "mt-0.5 font-bold font-mono text-emerald-400 text-xs", children: op.revives })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-center justify-between border-border/30 border-t pt-3 font-mono text-[10px]", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden overflow-x-auto sm:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left text-xs", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-border/20 border-b pb-2 font-mono text-[10px] text-muted-foreground uppercase", children: [
            /* @__PURE__ */ jsx("th", { className: "pb-2 font-medium", children: "Operador" }),
            /* @__PURE__ */ jsx("th", { className: "pb-2 text-center font-medium", children: "Partidas" }),
            /* @__PURE__ */ jsx("th", { className: "pb-2 text-center font-medium", children: "K/D/A" }),
            /* @__PURE__ */ jsx("th", { className: "pb-2 text-center font-medium", children: "KDR" }),
            /* @__PURE__ */ jsxs("th", { className: "flex items-center justify-center gap-1 pb-2 text-center font-medium", children: [
              /* @__PURE__ */ jsx(Heart, { className: "h-3 w-3 text-red-500" }),
              " Reanim."
            ] }),
            /* @__PURE__ */ jsx("th", { className: "pb-2 text-center font-medium", children: "Estado Prom." })
          ] }) }),
                ...
                children: [
                  /* @__PURE__ */ jsx("td", { className: "py-3 font-semibold", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxs(
                      "span",
                      {
                        className: isMe ? "font-extrabold text-emerald-500 dark:text-emerald-400" : "text-foreground",
                        children: [
                          cleanGamertag(op.gamertag),
                          " ",
                          isMe && "(Tú)"
                  ...
                  /* @__PURE__ */ jsx("td", { className: "py-3 text-center font-bold font-mono text-primary", children: op.kdr }),
                  /* @__PURE__ */ jsx("td", { className: "py-3 text-center font-mono font-semibold text-emerald-400", children: op.revives }),
...
function DashboardContent({
  ...
  return /* @__PURE__ */ jsx(NotificationProvider, { children: /* @__PURE__ */ jsxs("div", { className: "flex min-h-[calc(100vh-4rem)] flex-1 flex-col bg-background xl:flex-row", children: [
    /* @__PURE__ */ jsx(
      SquadSidebar,
      {
        allSquads,
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col", children: [
      ...
      /* @__PURE__ */ jsxs("main", { className: "flex-1 p-6 pb-16 xl:p-8", children: [
        ...
        activeTab === "stats" && /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-6", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-6 flex items-center justify-between border-border/40 border-b pb-4", children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("h3", { className: "flex items-center gap-2 font-bold text-foreground text-sm tracking-tight", children: [
              /* @__PURE__ */ jsx(BarChart3, { className: "h-4 w-4 text-muted-foreground" }),
              "Estadísticas Globales"
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mt-0.5 font-light text-muted-foreground text-xs", children: "Historial de rendimiento acumulado y análisis de supervivencia del escuadrón." })
          ] }) }),
          loadingStats ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16 text-center text-muted-foreground text-xs", children: [
            /* @__PURE__ */ jsxs(
              "svg",
              {
                "aria-label": "Cargando",
        ...
        activeTab === "settings" && isOwner && /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 xl:grid-cols-2", children: [
            ...
            /* @__PURE__ */ jsx(DeleteSquadSection, { squadId: squadState.id })
          ] })
        ] })
      ] })
    ] })
...
function DeleteSquadSection({ squadId }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4 rounded-lg border border-destructive/30 bg-destructive/5 p-5 xl:col-span-2", children: [
    /* @__PURE__ */ jsxs("div", { children: [
