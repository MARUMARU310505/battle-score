!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"bfcd9436403f315a94acf36ebfa581e3e93a06fc"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="b3f4f9ba-8116-493e-b183-69f5ef6383f8",e._sentryDebugIdIdentifier="sentry-dbid-b3f4f9ba-8116-493e-b183-69f5ef6383f8");}catch(e){}}();import './page-ssr_e8NL110z.mjs';
import { c as createComponent } from './astro-component_BDF6RDGh.mjs';
import 'piccolore';
import { Q as renderTemplate, T as maybeRenderHead } from './params-and-props_BwyISsjz.mjs';
import { r as renderComponent } from './entrypoint_B-q5n6qa.mjs';
import { a as actions } from './server_DaaDyCBD.mjs';
import { jsx, jsxs } from 'react/jsx-runtime';
import { Plus, Users, Check, Copy, LogIn, LogOut, ShieldCheck, Search } from 'lucide-react';
import { useState } from 'react';
import { B as Button, N as Nav } from './nav_x8l4dnRl.mjs';
import { S as SquadWizard } from './squad-wizard_Bz3htCkd.mjs';
...
function SquadHubContainer({
  ...
  if (isCreating) {
    return /* @__PURE__ */ jsx("div", { className: "flex min-h-[calc(100vh-4rem)] flex-1 items-center justify-center bg-background p-8", children: /* @__PURE__ */ jsx(SquadWizard, { onCancel: () => setIsCreating(false) }) });
  }
  return /* @__PURE__ */ jsx(
    SquadHub,
    {
...
function SquadHub({
  ...
  const handleJoinSquad = async (e) => {
    ...
    if (!(operatorGamertag.trim() && operatorRealName.trim()) || operatorLevel < 1) {
      setSearchError(
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx(
                        "input",
                        {
                          ...
                          id: "hub-level",
                          min: "1",
                          onChange: (e) => setOperatorLevel(Number(e.target.value) || 1),
                          required: true,
                          type: "number",
                          value: operatorLevel
                        }
