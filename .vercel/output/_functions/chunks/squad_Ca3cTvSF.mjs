!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"868d09a78c4a6c74e50b571ee83e8ad56070eacc"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e6b51125-b423-4739-8195-aa54958caa14",e._sentryDebugIdIdentifier="sentry-dbid-e6b51125-b423-4739-8195-aa54958caa14");}catch(e){}}();import './page-ssr_ChDEEW56.mjs';
import { c as createComponent } from './astro-component_DB_1XKrL.mjs';
import 'piccolore';
import { Q as renderTemplate, T as maybeRenderHead } from './params-and-props_DeehvyGh.mjs';
import { r as renderComponent } from './entrypoint_BPYdHC0P.mjs';
import { a as actions } from './server_lN53Sfat.mjs';
...
import { B as Button, N as Nav } from './nav_1SPPGoi7.mjs';
import { S as SquadWizard } from './squad-wizard_VQ1WYgO5.mjs';
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx(
            "input",
            {
              ...
              id: "match-ping",
              min: "0",
              onChange: (e) => setPing(Number.parseInt(e.target.value, 10) || 0),
              type: "number",
              value: ping
            }
          )
      ...
      /* @__PURE__ */ jsx("div", { className: "max-h-[50vh] space-y-4 overflow-y-auto pr-1", children: playerStats.map((stat, idx) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 sm:grid-cols-5", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(
                  "label",
                  {
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-3 sm:grid-cols-3 sm:items-end", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(
                  "label",
                  {
                ...
                /* @__PURE__ */ jsx(
                  "select",
                  {
                    ...
                    onChange: (e) => handleStatChange(idx, "primaryWeapon", e.target.value),
                    value: stat.primaryWeapon,
                    children: WEAPONS.map((w) => /* @__PURE__ */ jsx("option", { value: w, children: w }, w))
                  }
                )
              ] }),
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                        /* @__PURE__ */ jsxs("div", { className: "hidden text-right sm:block", children: [
                          /* @__PURE__ */ jsx("p", { className: "font-mono text-[10px] text-muted-foreground", children: "PING" }),
                          /* @__PURE__ */ jsxs("p", { className: "font-mono text-foreground text-xs", children: [
                            match.ping,
                            " ms"
                          ] })
                        ] }),
                ...
                isExpanded && /* @__PURE__ */ jsxs("div", { className: "space-y-3 border-border/40 border-t bg-card/40 p-4", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left font-sans text-xs", children: [
                    /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-border/30 border-b font-mono text-[10px] text-muted-foreground uppercase", children: [
                      ...
                      /* @__PURE__ */ jsx("th", { className: "py-2 text-center", children: "Arma" }),
                        ...
                        return /* @__PURE__ */ jsxs(
                          "tr",
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsx("td", { className: "py-2 text-center font-light text-muted-foreground", children: stat.primary_weapon }),
