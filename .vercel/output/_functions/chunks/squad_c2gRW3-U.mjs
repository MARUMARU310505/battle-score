!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"6985fa436af79296ab7c8443a7eaebcb46eafa16"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="4d75a69f-451a-466f-9020-fb03afb4481a",e._sentryDebugIdIdentifier="sentry-dbid-4d75a69f-451a-466f-9020-fb03afb4481a");}catch(e){}}();import './page-ssr_ZqQIrHgT.mjs';
import { c as createComponent } from './astro-component_CY9hAGsX.mjs';
import 'piccolore';
import { Q as renderTemplate, T as maybeRenderHead } from './params-and-props_D8DMEZSK.mjs';
import { r as renderComponent } from './entrypoint_yOAA-KsW.mjs';
import { a as actions } from './server_CotElSJE.mjs';
...
import { B as Button, N as Nav } from './nav_Z8iJJp37.mjs';
import { S as SquadWizard } from './squad-wizard_CwsawIyk.mjs';
import { a as createSupabaseBrowserClient } from './supabase_BYSzI6lG.mjs';
import { $ as $$BaseLayout } from './base-layout_BfaFd_6p.mjs';
...
function MatchForm({
  ...
  const [hostility, setHostility] = useState("Media");
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-6 shadow-sm", children: [
    ...
    /* @__PURE__ */ jsxs("form", { className: "space-y-6", onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-4 rounded-lg border border-border/50 bg-background/20 p-4", children: [
        /* @__PURE__ */ jsxs("h4", { className: "font-bold text-foreground text-xs uppercase tracking-wider border-b border-border/20 pb-2", children: [
          "1. Información General de la Partida ",
          !isOwner && /* @__PURE__ */ jsx("span", { className: "text-[10px] text-amber-500 font-normal lowercase italic", children: "(solo lectura para invitados)" })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4 rounded-lg border border-border/50 bg-background/20 p-4", children: [
        /* @__PURE__ */ jsxs("h4", { className: "font-bold text-foreground text-xs uppercase tracking-wider border-b border-border/20 pb-2", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[10px] text-amber-500 font-normal lowercase italic", children: "(solo puedes modificar tu propio slot)" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "max-h-[50vh] space-y-4 overflow-y-auto pr-1", children: playerStats.map((stat, idx) => {
          const canEditPlayer = isOwner || stat.userId !== null && stat.userId !== void 0 && stat.userId === currentUserId;
          return /* @__PURE__ */ jsxs(
            "div",
            {
              className: `space-y-3 rounded-lg border p-4 transition-colors duration-200 ${canEditPlayer ? "border-primary/20 bg-primary/5" : "border-border/60 bg-background/30 opacity-75"}`,
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-border/40 border-b pb-2", children: [
                  /* @__PURE__ */ jsxs("span", { className: "font-bold text-foreground text-xs flex items-center gap-1.5", children: [
                    stat.gamertag,
                    stat.userId === currentUserId && /* @__PURE__ */ jsx("span", { className: "rounded bg-primary px-1.5 py-0.2 text-[8px] font-semibold text-primary-foreground uppercase", children: "Tú" })
                  ] }),
...
function SquadHeader({ activePlayers }) {
  return /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-4 xl:grid-cols-2 xl:grid-cols-4", children: activePlayers.map((player) => {
...
function SquadRoster({
  ...
  const handleClassChange = async (slot, active_class) => {
    const updated = activePlayers.map((player) => {
      if (player.slot_number !== slot) {
        return player;
      }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-4", children: activePlayers.map((player) => {
      ...
      const canEditClass = isOwner || player.user_id !== null && player.user_id !== void 0 && player.user_id === currentUserId;
      return /* @__PURE__ */ jsxs(
        "div",
        {
...
function SessionPanel({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 xl:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-4 xl:col-span-2", children: isRegisteringMatch ? /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsx(
          Button,
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-border/40 border-b pb-4", children: [
          ...
          initialSession.status === "active" && /* @__PURE__ */ jsx(Button, { onClick: () => setIsRegisteringMatch(true), size: "sm", className: "px-4 py-2 h-auto", children: "+ Registrar Partida" })
        ] }),
            ...
            "div",
            {
              ...
              children: [
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                        /* @__PURE__ */ jsx(
                          "span",
                          {
                            className: `flex h-6 w-6 items-center justify-center rounded-full font-mono font-semibold text-xs ${match.placement === 1 ? "border border-amber-500/30 bg-amber-500/20 text-amber-500 border" : match.placement === 2 ? "border border-slate-300/40 bg-slate-300/20 text-slate-400 dark:text-slate-300 border" : match.placement === 3 ? "border border-amber-700/30 bg-amber-700/20 text-amber-700 dark:text-amber-600 border" : match.placement === 4 || match.placement === 5 ? "border border-blue-500/30 bg-blue-500/20 text-blue-500 border" : "bg-muted text-muted-foreground"}`,
                ...
                isExpanded && /* @__PURE__ */ jsxs("div", { className: "space-y-3 border-border/40 border-t bg-card/40 p-4", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "hidden xl:block overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left font-sans text-xs", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "block xl:hidden space-y-2.5", children: match.player_match_stats?.map(
                    (stat) => {
                      const k = stat.kills || 0;
                      const d = stat.downs || 0;
                      const kdr = d > 0 ? (k / d).toFixed(2) : k.toFixed(2);
                      ...
                      return /* @__PURE__ */ jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between border-b border-border/20 pb-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                              /* @__PURE__ */ jsx("span", { className: "font-bold text-foreground", children: stat.gamertag }),
                            ...
                            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-x-4 gap-y-2 pt-2 text-[11px]", children: [
                              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                                /* @__PURE__ */ jsx("span", { className: "text-muted-foreground font-light", children: "K/D/A (KDR):" }),
                                /* @__PURE__ */ jsxs("span", { className: "font-mono font-semibold text-foreground", children: [
                                  ...
                                  stat.assists,
                                  " ",
                                  /* @__PURE__ */ jsxs("span", { className: "text-muted-foreground text-[9px]", children: [
                                    "(",
                                    kdr,
                                    ")"
                                  ] })
                              ...
                              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                                /* @__PURE__ */ jsx("span", { className: "text-muted-foreground font-light", children: "Reanimaciones:" }),
                                /* @__PURE__ */ jsx("span", { className: "font-mono font-semibold text-foreground", children: stat.revives })
                              ] }),
                              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                                /* @__PURE__ */ jsx("span", { className: "text-muted-foreground font-light font-sans", children: "Reaparecido:" }),
                                /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: stat.respawned ? "Sí ✅" : "No ❌" })
                              ] }),
                              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                                /* @__PURE__ */ jsx("span", { className: "text-muted-foreground font-light font-sans", children: "Fase Final:" }),
                                /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: stat.end_game ? "Sí ✅" : "No ❌" })
                              ] }),
                              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center col-span-2 border-t border-border/10 pt-2 mt-1", children: [
                                /* @__PURE__ */ jsx("span", { className: "text-muted-foreground font-light font-sans", children: "Estado Mental:" }),
                                /* @__PURE__ */ jsx(
                                  "span",
                                  {
...
function SquadSidebar({
  ...
  return /* @__PURE__ */ jsxs("aside", { className: "flex xl:min-h-[calc(100vh-4rem)] min-h-0 w-full flex-col justify-between border-border border-r bg-card p-4 xl:w-64", children: [
