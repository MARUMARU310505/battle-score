!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"9c4acfc3e20988b98dc995e1b76f520c831dcaf0"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="cc5a9693-1014-4f9b-bbf9-4b966e304fe4",e._sentryDebugIdIdentifier="sentry-dbid-cc5a9693-1014-4f9b-bbf9-4b966e304fe4");}catch(e){}}();import './page-ssr_BTy2F7dy.mjs';
import { c as createComponent } from './astro-component_BF-BId3K.mjs';
import 'piccolore';
import { Q as renderTemplate, T as maybeRenderHead } from './params-and-props_mqaF-xz7.mjs';
import { r as renderComponent } from './entrypoint_DhYEayIz.mjs';
import { a as actions } from './server_CjNBxXCh.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { AlertCircle, User, Award, Loader2 } from 'lucide-react';
import { useState } from 'react';
import { B as Button, N as Nav } from './nav_3AXwXjL2.mjs';
import { $ as $$BaseLayout } from './base-layout_BCh0wX4P.mjs';

function ProfileForm({ initialProfile }) {
  const initialGamertagValue = initialProfile?.gamertag ? initialProfile.gamertag.split("||")[0] : "";
  const initialSeedValue = initialProfile?.gamertag?.includes("||") ? initialProfile.gamertag.split("||")[1] : initialGamertagValue;
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const fullGamertag = gamertag.trim() + "||" + (avatarSeed || gamertag).trim();
  ...
  return /* @__PURE__ */ jsx("div", { className: "mx-auto w-full max-w-md", children: /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-xl border border-border bg-card text-card-foreground shadow-lg backdrop-blur-md", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6 p-6 xl:p-8", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center space-y-3 py-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            type: "button",
            variant: "outline",
            children: /* @__PURE__ */ jsx("span", { children: "🎲 Cambiar Avatar" })
          }
        )
      ] })
    ] }),
